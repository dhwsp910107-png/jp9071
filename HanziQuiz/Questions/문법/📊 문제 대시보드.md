...
cssclasses:
  - dashboard
times: ["09:45:56"]
created-datetime: "2025. 11. 11. 오전 09:45:56"
---

# � 문법

> **문제 관리 대시보드** | 📅 2025. 11. 11. 오전 09:45:56

---

```dataviewjs
const thisFile = dv.current();
dv.paragraph(`📅 **생성일시**: ${thisFile["created-datetime"] || "2025. 11. 11. 오전 09:45:56"}`);
...
```dataviewjs
const folderPath = "HanziQuiz/Questions/문법";
...
*📅 생성일: 2025. 11. 11. 오전 09:45:56 | 🔄 실시간 업데이트 | 📱 모바일 최적화*
