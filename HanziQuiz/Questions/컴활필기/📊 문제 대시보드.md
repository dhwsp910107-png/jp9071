...
cssclasses:
  - dashboard
times: ["12:04:24"]
created-datetime: "2025. 11. 29. 오후 12:04:24"
---

# � 컴활필기

> **문제 관리 대시보드** | 📅 2025. 11. 29. 오후 12:04:24

---

```dataviewjs
const thisFile = dv.current();
dv.paragraph(`📅 **생성일시**: ${thisFile["created-datetime"] || "2025. 11. 29. 오후 12:04:24"}`);
...
```dataviewjs
const folderPath = "HanziQuiz/Questions/컴활필기";
...
```dataviewjs
const folder = "HanziQuiz/Questions/컴활필기";
...
*📅 생성일: 2025. 11. 29. 오후 12:04:24 | 🔄 실시간 업데이트 | 📱 모바일 최적화*
