...
cssclasses:
  - dashboard
times: ["08:45:08"]
created-datetime: "2025. 11. 11. 오전 08:45:08"
---

# � 한자

> **문제 관리 대시보드** | 📅 2025. 11. 11. 오전 08:45:08

---

```dataviewjs
const thisFile = dv.current();
dv.paragraph(`📅 **생성일시**: ${thisFile["created-datetime"] || "2025. 11. 11. 오전 08:45:08"}`);
...
```dataviewjs
const folderPath = "HanziQuiz/Questions/한자";
...
*📅 생성일: 2025. 11. 11. 오전 08:45:08 | 🔄 실시간 업데이트 | 📱 모바일 최적화*
