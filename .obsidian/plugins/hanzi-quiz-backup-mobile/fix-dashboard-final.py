...
old_function = """        async createIntegratedDashboard() {
...
'        html += `<a href="${q.file.path}" class="question-item"><div class="q-hanzi">${q.hanzi || "-"}</div><div class="q-info"><div class="q-text">${q.question || ""}</div><div class="q-meta"><span class="badge">${diffIcon} ${q.difficulty || "보통"}</span><span class="badge">📁 ${q.folder || "기본"}</span></div></div></a>`;\\n' +
'    }\\n' +
'    html += "</div>";\\n' +
'    dv.paragraph(html);\\n' +
'} else {\\n' +
...
'        html += `<a href="${q.file.path}" class="question-item"><div class="q-hanzi">${q.hanzi || "-"}</div><div class="q-info"><div class="q-text">${bookmarkIcon} ${q.question || ""}</div><div class="q-meta"><span class="badge">${diffIcon} ${q.difficulty || "보통"}</span><span class="badge">📁 ${q.folder || "기본"}</span>${wrongBadge}</div></div></a>`;\\n' +
'    }\\n' +
'    html += "</div>";\\n' +
'    dv.paragraph(html);\\n' +
'} else {\\n' +
...
print("✅ 대시보드 DataviewJS 문법 오류 수정 완료!")
print("   - 백틱 템플릿 리터럴을 문자열 연결로 변경")
print("   - 모든 따옴표 이스케이핑 수정 (\\\\\" 사용)")
