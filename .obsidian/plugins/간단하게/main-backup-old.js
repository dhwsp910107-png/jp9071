...
> [!example]- 📈 **시간 기록 방법**
> 
> 문제를 풀 때마다 타이머로 측정한 시간을 기록하세요:
> 
> | 회차 | 걸린 시간 | 날짜 | 비고 |
> |------|-----------|------|------|
> | 1회차 | 3분 25초 | 2025-01-15 | 처음 풀이 |
> | 2회차 | 2분 10초 | 2025-01-20 | 복습 |
> | 3회차 | 1분 45초 | 2025-01-25 | 숙달됨 |
...
> - 📚 **C급 (평민)**: 3회 이상 복습
> - 📖 **D급 (하층민)**: 2회 이상 복습
> - ❌ **E급 (노예)**: 1회 이하 또는 이해도 0

---

*⏱️ Stopwatch Timer로 측정한 시간이 자동으로 기록됩니다!*
...
class StudyDashboardView extends ItemView {
    constructor(leaf, plugin) {
        ...
        this.displayCount = 100; // 화면에 표시할 문제 개수
    }
                ...
                try {
                    ...
                    if (frontmatterMatch) {
                        ...
                        if (numberMatch) {
                            ...
                            // 복습 체크박스 개수 세기 (- [x] 1차 복습, - [x] 2차 복습 등)
