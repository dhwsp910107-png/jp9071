"""
문제 파일을 헤더 형식에서 Frontmatter 형식으로 자동 변환 (기본 폴더)
"""
import os
...
def main():
    base_path = Path(r'C:\ObsidianVaults\강의체크인\HanziQuiz\Questions\기본')
    ...
    print(f"📋 기본 폴더에서 {len(files_to_convert)}개 파일을 찾았습니다")
    print("변환을 시작합니다...\n")
